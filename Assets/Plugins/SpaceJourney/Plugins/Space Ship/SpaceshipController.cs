...
public class SpaceshipController : MonoBehaviour
{
	...
	public Vector4 SmoothedInput { get; set; }
    ...
    public void LateUpdate_bynet()
	{
		UpdateCamera();
	}

    public void Update_bynet()
	{
		UpdateInput();
    ...
    private void UpdateInput()
    {
        ...
        switch (m_input.Mode)
        {
            ...
            case InputMode.KeyboardAndMouse:
                ...
                Debug.Log(mouseOffsetFromScreenCenter);
        ...
        currentRawInput.w = EnableSpeedUp ? 1.0f : 0.0f;
